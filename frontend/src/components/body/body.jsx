...
const Body = () => {
    ...
    const questionsAndAnswers = [
      { question: 'Как я могу найти конкретную книгу на вашем сайте?', 
        answer: 'Найти интересующую вас книгу очень просто! Перейдите в раздел "Каталог", где вы сможете отфильтровать книги по различным категориям, а также отсортировать по цене. Также можно вопользоваться поиском: введите название книги, имя автора или жанр в строку поиска, расположенную в верхней части "Каталога". Начните вводить, и мы предложим вам варианты, соответствующие вашему запросу.' },
